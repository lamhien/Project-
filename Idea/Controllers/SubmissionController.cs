...
namespace Idea.Controllers
{
    public class SubmissionController : Controller
    {
        ...
        public async Task<IActionResult> AddIdea(NIdea nIdea, IFormFile file, bool isAcceptTerms)
        {
            ...
            if (isAcceptTerms)
            {
                ...
                if (submission.Deadline_1 >= DateTime.Now)
                {
                    ...
                    var coordinators = await _context.Users.Where(u => u.DepartmentId == departmentId && coordinatorIds.Contains(u.Id)).ToListAsync();
                    ...
                    return RedirectToAction(nameof(ViewIdeas), new { submissionid = nIdea.SubmissionId });
                }
            }
        ...
        public async void SendEmail(string userId, string content, string subject)
        {
            ...
            MailboxAddress from = new MailboxAddress("FGW Idea Management System", "HienLHGCS18867@fpt.edu.vn");
